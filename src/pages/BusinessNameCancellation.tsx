...
const BusinessNameCancellation = () => {
  ...
  const handleSubmit = () => {
    if (validate()) {
      navigate("/apply", { state: { service: "Business Name Cancellation", formData: form } });
    }
  };
          ...
          <div className="mx-auto max-w-[1100px] -mt-36 md:-mt-44">
            <div className="rounded-2xl bg-card shadow-xl shadow-primary/[0.08] ring-1 ring-border/50">
              ...
              <div className="px-6 pt-28 pb-2 md:px-10 md:pt-28 text-center">
                <h1 className="text-2xl font-extrabold leading-tight text-foreground md:text-4xl">Cancel your Business Name, ABN or GST in minutes

                </h1>
                <p className="mt-2 text-primary my-[13px] text-lg font-medium">Follow the simple steps below to submit your cancellation request securely.
              ...
              {/* Process summary */}
              <div className="px-6 md:px-10 mx-[40px] pb-[40px]">
...
export default BusinessNameCancellation;