...
const GSTCancellation = () => {
  ...
  return (
    <Layout>
      ...
      <section className="relative bg-muted/30 pb-12 md:pb-16 pt-0">
          ...
          <div className="mx-auto max-w-[1100px] -mt-36 md:-mt-44">
            <div className="rounded-2xl bg-card shadow-xl shadow-primary/[0.08] ring-1 ring-border/50">
              ...
              <div className="px-6 pt-28 pb-2 md:px-10 md:pt-28 text-center">
                <h1 className="text-2xl font-extrabold leading-tight text-foreground md:text-4xl">Cancel your GST,ABN or Business Name in minutes

                </h1>
                <p className="mt-2 text-primary my-[13px] text-lg font-medium px-0 pr-0 pt-[5px] py-[10px]">Follow the simple steps below to submit your cancellation request securely.
