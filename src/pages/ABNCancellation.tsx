...
const ABNCancellation = () => {
  ...
  const handleSubmit = () => {
    if (validate()) {
      navigate("/apply", { state: { service: "ABN/GST/Business Name Cancellation", formData: form } });
    }
  };
          ...
          <div className="mx-auto max-w-[1100px] -mt-36 md:-mt-44">
            <div className="rounded-2xl bg-card shadow-xl shadow-primary/[0.08] ring-1 ring-border/50">
              ...
              <div className="px-6 pt-28 md:px-10 md:pt-28 text-center mx-[62px] pb-[20px]">
                <h1 className="text-2xl font-extrabold leading-tight text-foreground md:text-4xl">Cancel your ABN, GST or Business Name in minutes

                </h1>
                <p className="mt-2 text-primary my-[13px] text-lg font-medium px-0 py-[10px]">Follow the simple steps below to submit your cancellation request securely.
              ...
              <div className="border-t border-border">
                <div className="px-6 pt-6 md:px-8 md:pt-7 [&>*]:mx-auto [&>*]:max-w-[570px]">
                  ...
                  <div className="mt-2 text-sm text-muted-foreground">
                    ...
                    <p className="mt-1.5">There are a number of reasons why we may initiate the cancellation of a business name. Some common reasons include:</p>
                    <ul className="mt-1.5 space-y-1 ml-4">
                      ...
                      <li className="flex gap-2"><span className="text-primary">•</span>We become aware of a matter after registration that would have affected the decision to register the business name</li>
                      ...
                      <li className="flex gap-2"><span className="text-primary">•</span>The entity fails to notify a change in information within the required time</li>
                    ...
                    <div className="max-w-md">
                      ...
                      <div className="rounded-lg border border-border/60 bg-muted/30 p-4">
                        ...
                        <ul className="mt-2 space-y-1.5 text-xs text-muted-foreground">
                          ...
                          <li className="flex gap-2"><span className="text-primary">•</span>We can attempt to obtain this ASIC key to be emailed to your address if your details are correct and up to date with ASIC</li>
